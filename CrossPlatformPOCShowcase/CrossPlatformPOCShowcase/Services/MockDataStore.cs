...
namespace CrossPlatformPOCShowcase.Services
{
    public class MockDataStore : IDataStore<Item>
    {
        ...
        public MockDataStore()
        {
            items = new List<Item>()
            {
                new Item { Id = Guid.NewGuid().ToString(), Text = "First item", Description="This is an item description.", Category = ItemCategory.Personal },
                new Item { Id = Guid.NewGuid().ToString(), Text = "Second item", Description="This is an item description.", Category = ItemCategory.Personal },
                ...
                new Item { Id = Guid.NewGuid().ToString(), Text = "Fifth item", Description="This is an item description." , Category = ItemCategory.Personal},
